...
![Node-RED import screenshot](../IoT-AssetTracking-Perishable-Network-Blockchain/tree/master/Node-RED/screenshots/IBMCloud-NodeRED-import.png)
* Paste the text of the flow into the **Import nodes** dialog and press the red **Import** button.
![Node-RED import from clipboard screenshot](../IoT-AssetTracking-Perishable-Network-Blockchain/tree/master/Node-RED/screenshots/IBMCloud-NodeRED-pastefromclipboard.png)
